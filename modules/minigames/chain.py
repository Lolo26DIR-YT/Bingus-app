...
class ChainGame(ctk.CTkFrame):
    def __init__(self, parent, target, on_complete, profile=None, **kwargs):
        ...
        title = ctk.CTkLabel(self, text="Mini-jeu : Chaîne d'exploits", font=ctk.CTkFont(size=18, weight="bold"), text_color="#66fcf1")
        ...
        self.step_label.grid(row=1, column=0, sticky="w", padx=16, pady=(0, 8))

        self.next_button = ctk.CTkButton(self, text="Suivant", command=self._advance, fg_color="#45a29e")
        self.next_button.grid(row=2, column=0, sticky="ew", padx=16, pady=(0, 12))
